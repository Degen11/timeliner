            ...
            >
              <span
                className={clsx(
                  ...
                  selected
                    ? [
                        actionColor === 'add' ? 'bg-[#52525b]' : 'bg-red-500',
      ...
      {count > 0 && (
        ...
        >
              ...
              <div className="flex gap-1.5 mb-2">
                ...
                <Select value={shiftUnit} onValueChange={setShiftUnit}>
                  ...
                  <SelectContent className="border-[#3f3f46] bg-[#27272a]">
                    <SelectItem
                      value="day"
                      className="text-xs text-[#f0f0f0] focus:bg-white/10 focus:text-white"
                    >
                      Days
                    </SelectItem>
                    <SelectItem
          ...
          <button
            ...
            aria-label={
              deleteConfirm.isArmed ? 'Confirm delete selected events' : 'Delete selected events'
            }
          >
            <Trash2 size={14} />
            <span>{deleteConfirm.isArmed ? 'Confirm' : 'Delete'}</span>
            {deleteConfirm.isArmed && (
              <span className="absolute bottom-0 left-0 h-0.5 bg-white/40 animate-[countdown_3s_linear_forwards]" />
            )}
          </button>
