  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <textarea
        ...
        className={`w-full rounded-xl border bg-gray-50 dark:bg-white/5 px-4 py-3 text-base sm:text-sm text-text-default placeholder:text-text-muted focus:border-secondary focus:outline-none focus:ring-2 focus:ring-secondary/10 resize-y transition-all ${
