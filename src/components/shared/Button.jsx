export default function Button({
  ...
  const variants = {
    ...
    secondary: 'bg-white text-gray-700 hover:bg-soft-accent hover:text-secondary hover:border-secondary/30 hover:shadow-md hover:scale-[1.02] active:scale-[0.98] border border-gray-200 shadow-sm',
    ghost: 'text-gray-500 hover:text-secondary hover:bg-soft-accent hover:scale-[1.02] active:scale-[0.98]',
